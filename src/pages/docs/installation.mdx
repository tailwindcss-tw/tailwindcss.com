...
如果這對你來說有點困難，又或者你不想透過 PostCSS 來架設 Tailwind CSS，你可以用 [不透過 PostCSS 來設定 Tailwind] 這邊提供的方法來完成安裝。
...
為了解決 Tailwind 生成 CSS 時[不自動添加供應商前綴(vendor prefixes)]的情形，這裡推薦可以使用上面這行指令安裝 autoprefixer 來處理問題。
...
但是如果用我們提供的 [最佳做法][best practices] ，可以把檔案大小壓在 10kB 以下。
...
[CDN]: #透過-CDN-方式引入Tailwind 

[以 PostCSS 插件的方式來安裝 Tailwind CSS]: #以-PostCSS-插件的方式來安裝-Tailwind-CSS

[autoprefixer]: https://github.com/postcss/autoprefixer

[不透過 PostCSS 來設定 Tailwind]: https://tailwindcss.com/docs/using-with-preprocessors#using-post-css-as-your-preprocessor

[不自動添加供應商前綴(vendor prefixes)]: https://tailwindcss.com/docs/browser-support#vendor-prefixes

[安裝 PostCSS 7 的相容版本]: #PostCSS-7-的相容性版本

[PostCSS 預編譯器]: https://tailwindcss.com/docs/using-with-preprocessors
...
[switch to our PostCSS 7 compatibility build]: #PostCSS-7-的相容性版本

[default configuration]: https://unpkg.com/browse/tailwindcss@%5E2/stubs/defaultConfig.stub.js
...
[指令]: https://tailwindcss.com/docs/functions-and-directives
