...
description: "控制元素背景定界框的功能Utilities for controlling the bounding box of an element's background."
---
...
如要將元素的背景定界框控制在特定斷點，在任何一個既有背景材切功能的前綴詞加上 `{screen}:` 。例如，使用 `md:bg-clip-padding` 時，只有中型或以上的螢幕尺寸有 `bg-clip-padding` 效果。
