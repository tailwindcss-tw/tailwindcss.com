...
<template preview class="p-4">
  <div class="flex justify-center content-center flex-wrap h-24 bg-stripes2 bg-stripes-rose-500 rounded-lg">
    <div class="backdrop-filter backdrop-blur-sm w-1/5 h-12 text-white text-2xl font-extrabold rounded-md flex items-center justify-center bg-rose-500 bg-opacity-20">
      DEMO
    </div>
  </div>
</template>
