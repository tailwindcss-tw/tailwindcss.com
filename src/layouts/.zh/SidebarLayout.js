  ...
  return (
    <>
      ...
      <TopLevelLink
        mobile={mobile}
        href="/zh/resources"
        isActive={pathname === '/zh/resources'}
        className="mb-4"
      ...
      >
        <span className={pathname === '/zh/resources' ? 'dark:text-purple-400' : ''}>Resources</span>
      </TopLevelLink>
      <TopLevelLink
        mobile={mobile}
